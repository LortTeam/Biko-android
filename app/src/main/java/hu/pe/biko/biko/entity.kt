...
data class Route(var name: String, var description: String, var address: String,
                 var city: String, var country: String, var state: String, var distance: Int, var time: Int)
